        ...
        <footer className=" dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="mb-6 md:mb-0 flex justify-center items-center">
                    <a href="#">
                        <img src="/logo-white.png" className="h-20" alt="WeGrow Logo" />
                        {/* <span className="self-center text-4xl font-semibold whitespace-nowrap dark:text-white">WeGrow</span> */}
                    </a>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            <li className="mb-4">
                                <a href="#" className="hover:underline">WeGrow</a>
                            </li>
                            <li>
